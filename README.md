...
SOA means that you structure your application by decomposing it into multiple services (most commonly as HTTP services) that can be classified as different types like subsystems or tiers.
    ...
    The software components are developed as services to be exposed via APIs, as SOA would require. An API 
    broker mediates access to components and ensures security and governance practices are followed. 
