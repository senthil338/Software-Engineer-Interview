[Source code](https://github.com/senthil338/coding_interview/blob/master/CodingPractice/CodingPractice/DataStructure/Trees/TreeNode.cs)

##### Important Topic:
1. Binary Tree
2. Binary Search Tree
3. N-Ary Tree or Trees (This page)
